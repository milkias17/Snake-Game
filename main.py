...
class Snake:
    def __init__(self, screen):
        ...
        self.speed = 10
        self.blocks = [pygame.Rect(40, 40, 10, 10), pygame.Rect(30, 40, 10, 10),
                       pygame.Rect(20, 40, 10, 10), pygame.Rect(10, 40, 10, 10)]
...
class Fruit:
    ...
    def draw(self, game_screen):
        self.rect = pygame.draw.circle(game_screen, (255, 0, 0), (self.x, self.y), 5)
